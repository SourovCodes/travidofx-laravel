...
export default function FloatingWhatsApp() {
    return (
        ...
        >
            ...
            <span className="font-display pointer-events-none absolute right-full mr-3 translate-x-1 rounded-md bg-black/85 px-3 py-1.5 text-xs font-semibold whitespace-nowrap text-white opacity-0 transition-all group-hover:translate-x-0 group-hover:opacity-100">
                Chat on WhatsApp
            </span>
        </a>
    );
