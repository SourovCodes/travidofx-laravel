            ...
            <section className="relative bg-black pt-12 pb-14">
                <div className="container-x mx-auto max-w-3xl text-center">
                    <h2 className="font-display text-[clamp(1.8rem,2.4vw+.8rem,2.6rem)] font-medium">
                        <Link
                            href="/"
                            className="hover:text-shape text-white transition-colors"
                        >
                            Tradivo.com
                        </Link>
                    </h2>
                    <p className="mt-5 text-[15px] leading-[1.75] text-white/80">
                        Discover the edge in automated trading with Tradivo Magic EA V12 — an
                        advanced Gold &amp; BTC Expert Advisor for MT5. HTF trend filtering,
                        counter-trend grid execution, recovery protection, and smart basket
                        profit targeting in one disciplined algorithmic system. Powered by
                        Tradivo FX Limited.
                    </p>
                    ...
                    <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
                        {SOCIALS.map((s) => (
                            <a
                                ...
                                aria-label={s.name}
                                className="hover:border-shape hover:bg-shape/10 inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-white/[0.03] text-white/80 transition-colors hover:text-white"
                            >
                                {s.icon}
                            </a>
                        ))}
